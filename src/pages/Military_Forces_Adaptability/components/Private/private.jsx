            ...
            <div>
              ...
              <div style={{ margin: "1em 0em" }} className="card-m-container">
                <div className="card-m">
                  {recentAdaptability?.data && (
                    <span className="font-l weight-l">
                      {recentAdaptability?.data["생활/업무만족"]}/5
                    </span>
                  )}
                ...
                <div className="card-m">
                  {recentAdaptability?.data && (
                    <span className="font-l weight-l">
                      {recentAdaptability?.data["대인관계"]}/5
                    </span>
                  )}
                  <span className="font-xs weight-xs margin-b-1em">
                    대인관계
                ...
                <div className="card-m">
                  {recentAdaptability?.data && (
                    <span className="font-l weight-l">
                      {recentAdaptability?.data["이성"]}/5
                    </span>
                  )}
                  <span className="font-xs weight-xs margin-b-1em">이성</span>
                </div>

                <div className="card-m">
                  {recentAdaptability?.data && (
                    <span className="font-l weight-l">
                      {recentAdaptability?.data["경제"]}/5
                    </span>
                  )}
                  <span className="font-xs weight-xs margin-b-1em">경제</span>
                </div>
              </div>
            ...
            <div style={{ marginTop: "1.5em" }}>
              ...
              >
                ...
                <Button
                  style={{ flex: "1" }}
                  onClick={() =>
                    _getAdaptabilityResult(auth.employee_number, date, type)
                  }
                >
                  조회
                </Button>
                ...
                <thead className="table_header">
                  <tr>
                    ...
                    <th style={{ fontSize: "1.2em" }}>
                      기간 {adaptability?.datebegin} ~ {adaptability?.dateend}
                    </th>
                    ...
                    <td>
                      <Button
                        onClick={() => {
                          setVisibleDetail(true);
                          adaptability?.stat?.map((data) => {
                            if (data.name === "대인관계") setDetailData(data);
                          });
                        }}
                      >
                        상세보기
